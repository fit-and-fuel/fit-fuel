class PTBlogHandler extends elementorModules.frontend.handlers.Base {
    ...
    this.swiper = new Swiper(elements.$swiperContainer.get(0), swiperConfig);
	}
  ...
  initIsotope() {
    ...
    if (settings.type == 'grid' || settings.type == 'masonry' || settings.type == 'packery') {
